...
public final class ActivityIntroBinding implements ViewBinding {
  ...
  private ActivityIntroBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView) {
  ...
  public static ActivityIntroBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityIntroBinding((ConstraintLayout) rootView, textView);
    }
